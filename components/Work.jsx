  ...
  return (
    ...
    id="work" className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
            Welcome to my web development portfolio! Explore a Collections of projects 
            showcasing my expertise in front-end web development
        </motion.p>
        <motion.div 
          initial={{opacity:0}}
        whileInView={{opacity:1}}
        transition={{delay:0.9,duration:0.6}}
        className='grid grid-cols-2 my-10  gap-4'>
        ...
        transition={{delay:1.1,duration:0.5}}
          target="_blank" href="http://muscle-garage.netlify.app" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full y-3 px-10 mx-auto my-20 
            hover:bg-lime-300 duration-500
            '>
                Show More
